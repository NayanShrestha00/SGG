...
const AdminManagerForgotPassword = () => {
  ...
  const handleConfirmEmail = async (e) => {
    ...
    try {
        const apiEndpoint =
            data.role === "Admin"
                ? AdminManagerSummaryApi.AdminForgotPassword.url
                : AdminManagerSummaryApi.ManagerForgotPassword.url;
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const apiEndpoint =
        data.role === "Admin"
          ? AdminManagerSummaryApi.AdminResetPassword.url
          : AdminManagerSummaryApi.ManagerResetPassword.url;
...
export default AdminManagerForgotPassword;
